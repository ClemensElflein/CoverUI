/**
 * @file LEDcontrol_RM-ECOW-V100.cpp
 ...
 */
#include <Arduino.h>
#include "LEDcontrol_RM-ECOW-V100.hpp"
...
void LEDcontrolRMECOWV100::sequence_animate_handler()
{
...
void LEDcontrolRMECOWV100::show_countdown_state(unsigned int sec, LED_state state)
{
 ...
 */
void LEDcontrolRMECOWV100::sequence_countdown_handler()
{
 ...
 */
unsigned int LEDcontrolRMECOWV100::boot_animation() // A short boot animation which return the amount of ms it will take
{
 ...
 */
void LEDcontrolRMECOWV100::set_base10_leds(char digit)
{
...
void LEDcontrolRMECOWV100::force_off_num_seq_leds(bool force)
{
