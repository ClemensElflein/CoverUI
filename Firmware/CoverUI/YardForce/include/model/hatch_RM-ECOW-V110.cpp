 ...
 * @brief YardForce RM-ECOW-V1.1.0 CoverUI Hatch for OpenMower https://github.com/ClemensElflein/OpenMower
 * @version 0.1
 * @date 2024-06-27
 *
...
unsigned int HatchRMECOWV110::handle_button(unsigned int button_id, unsigned int press_cnt)
{
